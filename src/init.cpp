...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 60042 or testnet: 60142)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 60142 or testnet 60242)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    {
        uiInterface.InitMessage(_("Flapping The Fappin Blocks....Please Hold"));
    ...
    uiInterface.InitMessage(_("Final Coundown"));
    ...
    uiInterface.InitMessage(_("Launching"));
    printf("Done loading\n");
